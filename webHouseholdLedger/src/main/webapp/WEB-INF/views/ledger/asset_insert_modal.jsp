<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<!-- Insert Modal -->
<div class="modal fade" id="insert-asset-modal">
	<!-- Modal-dialog -->
	<div class="modal-dialog modal-default">
		...
		<div class="modal-content card-info">
			...
			<div class="modal-body">
				<form name="assetInsertForm" id="assetInsertForm" method="post">
					...
					<!-- 3.체크,신용 카드 - 연결 통장 -->
					<div id="insertCardAssetsDiv" style="display: none;">
						<div class="input-group mb-3">
							<div class="input-group-prepend">
			...
			<div class="modal-footer justify-content-between">
				...
				<button type="button" class="btn btn-primary" onclick="fn_insertAsset()">추가
					하기</button>
			</div>
